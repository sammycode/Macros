...
namespace VF.Macros.Data.SQLite.Repositories
{
    ...
    public class SQLiteMacroDataRepository : BaseAdoNetDataRepository, IMacroDataRepository
    {
        ...
        /// </summary>
        /// <param name="externalProviderCode">The External Provider Code</param>
        ...
        public IEnumerable<IMacro> GetMacroByQualifiedName(string providerCode, string qualifiedName)
        {
            try
            {
                string sql =
                    ...
                    $"      AND MS.{SQLiteDataContract.ExternalMacroSource.COLUMN_EXTERNAL_SOURCE_CODE_NAME} = @providerCode " +
                    $" ORDER BY" +
